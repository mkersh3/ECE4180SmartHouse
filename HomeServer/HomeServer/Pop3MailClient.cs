...
namespace MailHelper {
  ...
  public class mailClient
  {
      ...
      public string[] emailParse(string FileName)
      {
          ...
          int i = 0;
          while (fs.Read(inbuf,0,128) != 0)
          {
              total = total + System.Text.Encoding.Default.GetString(inbuf);
          }
          string[] broken = total.Split(new char [] {':','\n'} );
          ...
          string reemail = broken[i + 1];
          broken = reemail.Split(new char[] { '<', '>' });
          this.returnto = broken[1];
          //MessageBox.Show("return email = " + returnto);

          string[] body = total.Split('~');
      ...
      */
        ...
        public static void Send(string To, string Subject, string Body, string FileName)
        {
            ...
            client.Credentials = new NetworkCredential("smarthouse4180", "gatech4180");
            client.EnableSsl = true;

            // Send from Smart House email address.
            MailAddress from = new MailAddress("smarthouse4180@gmail.com", "Smart House", System.Text.Encoding.UTF8);
...
/*
        public void Send(string Subject, string Body, string FileName)
        {
            ...
            // Send to Smart House user email address.
            MailAddress to = new MailAddress(this.returnto, "Smart House User", System.Text.Encoding.UTF8);
...
//        }
        public static void Receive()
        {
            ...
            {
                // Preare Pop Client
                MailHelper.Pop3MailClient client = new MailHelper.Pop3MailClient("pop.gmail.com", 995, true, "smarthouse4180@gmail.com", "gatech4180");
                client.IsAutoReconnect = true;

                // Remove the following line if no tracing is needed
                client.Trace += new MailHelper.TraceHandler(Console.WriteLine);
